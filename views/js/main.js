...
var resizePizzas = function (size) {
	...
	function changePizzaSizes(size) {
		var pizzaValue = document. getElementsByClassName("randomPizzaContainer");
		var dx = determineDx(pizzaValue[0], size);
		var newwidth = (pizzaValue[0].offsetWidth + dx) + 'px';
		for (var i = 0; i < pizzaValue.length; i++) {
			pizzaValue[i].style.width = newwidth;
		}
	}
...
function updatePositions() {
	...
	//separated loops to prevent forced layouts and subsequent delays in rendering.
